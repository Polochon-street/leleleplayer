...
CFLAGS=
LDFLAGS=`pkg-config --cflags gtk+-2.0` `pkg-config --libs gtk+-2.0` -lavformat -lavutil -lopenal -lavcodec -lm -std=c99
MLDFLAGS=`x86_64-w64-mingw32-pkg-config --cflags gtk+-2.0` `x86_64-w64-mingw32-pkg-config --libs gtk+-2.0` -lavformat -lavutil -lavcodec -lOpenAL32 -lm -std=c99
...
gui_exe.o: gui.c
	@$(MCC) -o gui_exe.o -c gui.c `x86_64-w64-mingw32-pkg-config --cflags gtk+-2.0`
...
gui.o: gui.c
	@$(CC) -o gui.o -c gui.c `pkg-config --cflags gtk+-2.0`
